...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col items-center">
      <main className="container max-w-4xl mx-auto font-syne px-4">
        <h1 className="text-center mb-8 md:mb-16">
          <span className="block text-4xl md:text-6xl lg:text-9xl text-gray-800 font-sans">Welcome to</span>
          <span className="block text-4xl md:text-6xl lg:text-9xl text-gray-800 font-sans whitespace-nowrap">DreamScape AI™</span>
        </h1>
      </main>
